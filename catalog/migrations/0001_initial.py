    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summery', models.TextField(help_text='Enter a brife description of the boook.', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ststus', models.CharField(blank=True, choices=[('m', 'Maintenance'), ('o', 'On loan'), ('a', 'Available'), ('r', 'Reserved')], default='m', help_text='Book availability', max_length=1)),
